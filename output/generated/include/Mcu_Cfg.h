...
*   SW Version           : 1.0.2
*   Build Version        : S32K14x_MCAL_1_0_2_RTM_HF5_ASR_REL_4_2_REV_0002_20191119
*
...
#define McuModeSettingConf_Sleep   ((Mcu_ModeType)2U)
#define McuConf_McuModeSettingConf_McuModeSettingConf_Sleep   ((Mcu_ModeType)2U)
...
#define McuConf_McuResetReasonConf_MCU_LOSS_OF_LOCK_RESET   ((uint8)8U)

#define McuConf_McuResetReasonConf_MCU_LOSS_OF_CLOCK_RESET   ((uint8)9U)

#define McuConf_McuResetReasonConf_MCU_LOW_OR_HIGH_VOLTAGE_DETECT_RESET   ((uint8)10U)

#define McuConf_McuResetReasonConf_MCU_NO_RESET_REASON   ((uint8)11U)

#define McuConf_McuResetReasonConf_MCU_MULTIPLE_RESET_REASON   ((uint8)12U)

#define McuConf_McuResetReasonConf_MCU_RESET_UNDEFINED   ((uint8)13U)

#define McuConf_McuResetReasonConf_MCU_CMU_LOC_RESET   ((uint8)14U)
